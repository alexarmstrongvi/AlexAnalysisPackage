...
plot_defaults = {
    ...
    'Lep_Iso'              : Plot1D( bin_range=[-0.5, 4.5],   bin_width=1, xlabel='Lepton Isolation (non-inclusive)'),
    ...
    'MET'                  : Plot1D( bin_range=[64, 80],  bin_width=1, xunits='GeV', xlabel='E_{T}^{miss}'),
...
YIELD_TBL.formulas['Purity (%)'] = "(1 - MC/data)*100"
