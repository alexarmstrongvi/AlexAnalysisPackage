...
groups['higgs'] = groups['Htt'] + groups['HWW'] + groups['HV'] + groups['ttH']
...
# Di/Triboson Samples
groups['VVV'] = [
    361620, 361621, 361622, 361623, 361624, 361625, 361626, 361627        
]
groups['VV'] = [
    363356, 363358, 
    363490, 363491, 363492,
...
groups['wjets'] = [
    # Higgs group samples (not being used)
    #361100, 361101, 361102, 361103, 361104, 361105,
    # Sherpa 2.2.1
    364156, 364157, 364158, 364159, 364160, 364161, 364162, 364163, 364164,
...
groups['zgamma'] = [
    ...
    364510, 364511, 364512, 364513, 364514, 
    364517, 364518, 364519
]
groups['wgamma'] = [
    364521, 364522, 364523, 364524, 364525, 364526, 364527, 364528, 364529, 364530, 
    364531, 364532, 364533, 364534, 364535
]
groups['v_gamma'] = groups['zgamma'] + groups['wgamma'] 
